...
client.on('message', function(msg) {
    if(msg.content.startsWith (prefix + 'information')) {
...
1  *credit : لارؤيه الكريدت حقتك
2  *daily : لاعطائك الكردت اليومي
3  *skin : لعرض السكن حقق
4  *movie : عرض معلومات الفلم
5  *new : <لعمل تكت <روم خاص فيك تتكلم مع الاونر
6  *gmail : لأانشاء جيميل وهمي
༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻
...
1  *clear : مسح الشات
2  *bc : برودكاست لجميع الاعضاء اون لاين و اوف لاين
3  *kick : لطرد عضو من السيرفر
4  *ban : لطرد عضو من السيرفر ولا يستطيع الدخول مرى اخرى
5  *mutechannel : لكل لا يستطيع احد الكتابه
6  *unmutechannel : لفتح الجات و يستطيعون الكتابه
7  *giveaway : لعمل كيف اوي 
༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻
Click On ▶ To Go To Bot Info
   `,`
༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻
1  *ping : لعرض سرعه الاتصال
2  *id : لعرض معلومات عنك
3  *server : احصائيات السيرفر
4  *information : احصائيات السيرفر مطوره
     || Bot By:SuchAli#0999 ||
༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻
   `]
 let page = 1;
